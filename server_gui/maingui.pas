...
uses
  ...
  LMessages,
  CommandLine, aboutform, FtpFunctions, FtpMain, FtpTypes, FtpConst ;
...
// TODO if close and server running and not end session query, prompt to quit
...
begin
    ...
    begin
        ...
        else if (ParamStr(liIndexParamStr) = '-lauch')
        then begin
            lbLauch := True ;
        end
